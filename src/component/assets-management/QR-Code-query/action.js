...
export const queryrecordlist = makeActionCreator(types.queryrecordlist, 'props');
export const queryrecordlistSuccess = makeActionCreator(types.queryrecordlistSuccess, 'data');
